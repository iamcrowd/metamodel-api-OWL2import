...
public class Ax3 extends AxToKFTools {
    ...
    public void type3asKF(Metamodel kf, OWLClassExpression left, OWLClassExpression right) {
        ...
        if (NormalForm.isAtom(filler)) {
            ...
            String complement_left_iri = URI_IMPORT_CONCEPT + "COMPLEMENT%" + URI_IMPORT_CONCEPT + prop_iri + "%"
                    + left_iri;
            ...
            // "#CPABc";
            String fresh_C_PABc = URI_IMPORT_CONCEPT + "COMPLEMENT%" + URI_IMPORT_CONCEPT + prop_iri + "%" + left_iri
                    + "$" + filler_iri;
            ...
            // "#PAcB1";
            String rel_fresh_PAcB1_iri = URI_IMPORT_CONCEPT + getAlphaNumericString(8) + "/" + prop_iri
                    + "-participation%" + complement_left_iri;

            // String role_fresh_CPAcB1_iri = URI_IMPORT_CONCEPT + getAlphaNumericString(8)
            // + "#RCPAcB1";
            String role_fresh_CPAcB1_iri = URI_IMPORT_CONCEPT + getAlphaNumericString(8) + "/participate-in%"
                    + prop_iri;
            // String role_fresh_AcPAcB1_iri = URI_IMPORT_CONCEPT + getAlphaNumericString(8)
            // + "#RAcPAcB1";
            String role_fresh_AcPAcB1_iri = URI_IMPORT_CONCEPT + getAlphaNumericString(8) + "/has-one%"
                    + complement_left_iri;
            ...
            Role role_fresh_AcPAcB1 = new Role(role_fresh_AcPAcB1_iri, ot_complement_left, r_fresh_PAcB1,
                    otc_RoleAcPAcB1);
            ...
            // String rel_P1_iri = prop_iri + "1"; //"http://crowd.fi.uncoma.edu.ar/IMPORT"
            ...
            // String rel_P2_iri = prop_iri + "2"; //"http://crowd.fi.uncoma.edu.ar/IMPORT"
     ...
     * @param right
     */
    public void type3ImportedAsKF(Metamodel kf, OWLClassExpression left, OWLClassExpression right) throws Exception {
