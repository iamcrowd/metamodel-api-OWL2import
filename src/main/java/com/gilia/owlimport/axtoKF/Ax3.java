...
public class Ax3 extends AxToKFTools {
    ...
    public void type3asKF(Metamodel kf, OWLClassExpression left, OWLClassExpression right) {
        ...
        // ((OWLQuantifiedRestrictionImpl<OWLClassExpression>) right).getFiller();
        // OWLPropertyExpression property =
        // ((OWLQuantifiedRestrictionImpl<OWLClassExpression>) right).getProperty();
        ...
        // String complement_left_iri = URI_IMPORT_CONCEPT + "COMPLEMENT%" +
        // URI_IMPORT_CONCEPT + prop_iri + "%"
        // + left_iri;
        ...
        // Subsumption sub_fresh_leftORcomplement = addSubsumption(kf, ot_fresh_O,
        // ot_fresh_left, dot);

        // Subsumption sub_fresh_leftORcomplement_2 = addSubsumption(kf, ot_fresh_O,
        // ot_complement_left, dot);

        // Subsumption sub_left_fresh_left = addSubsumption(kf, ot_fresh_left, ot_left);

        // // add subsumption CP
        // // String fresh_C_PAB = URI_IMPORT_CONCEPT + getAlphaNumericString(8) +
        // "#CPAB";
        // String fresh_C_PAB = URI_IMPORT_CONCEPT + prop_iri + "%" + left_iri + "$" +
        // filler_iri;
        // // String fresh_C_PABc = URI_IMPORT_CONCEPT + getAlphaNumericString(8) +
        // // "#CPABc";
        // String fresh_C_PABc = URI_IMPORT_CONCEPT + "COMPLEMENT%" + URI_IMPORT_CONCEPT
        // + prop_iri + "%" + left_iri
        // + "$" + filler_iri;
        ...
        // CompletenessConstraint cc = new
        // CompletenessConstraint(getAlphaNumericString(8));
        ...
        // Subsumption sub_fresh_CP_CPABc = addSubsumption(kf, ot_C_P, ot_fresh_C_PABc,
        // cc);
        ...
        // //
        // // String rel_fresh_PAcB1_iri = URI_IMPORT_CONCEPT + getAlphaNumericString(8)
        // +
        // // "#PAcB1";
        // String rel_fresh_PAcB1_iri = URI_IMPORT_CONCEPT + getAlphaNumericString(8) +
        // "/" + prop_iri
        // + "-participation%" + complement_left_iri;

        // // String role_fresh_CPAcB1_iri = URI_IMPORT_CONCEPT +
        // getAlphaNumericString(8)
        // // + "#RCPAcB1";
        // String role_fresh_CPAcB1_iri = URI_IMPORT_CONCEPT + getAlphaNumericString(8)
        // + "/participate-in%"
        // + prop_iri;
        // // String role_fresh_AcPAcB1_iri = URI_IMPORT_CONCEPT +
        // getAlphaNumericString(8)
        // // + "#RAcPAcB1";
        // String role_fresh_AcPAcB1_iri = URI_IMPORT_CONCEPT + getAlphaNumericString(8)
        // + "/has-one%"
        // + complement_left_iri;

        // ObjectTypeCardinality otc_RoleCPAcB1 = new
        // ObjectTypeCardinality(getAlphaNumericString(8), "1", "1");
        // ObjectTypeCardinality otc_RoleAcPAcB1 = new
        // ObjectTypeCardinality(getAlphaNumericString(8), "0", "*");
        ...
        // Role role_fresh_CPAcB1 = new Role(role_fresh_CPAcB1_iri, ot_fresh_C_PABc,
        // r_fresh_PAcB1, otc_RoleCPAcB1);

        // if (role_fresh_CPAcB1.hasMandatoryConstraint()) {
        // kf.addConstraint(role_fresh_CPAcB1.getMandatoryConstraint());
        // }

        // Role role_fresh_AcPAcB1 = new Role(role_fresh_AcPAcB1_iri,
        // ot_complement_left, r_fresh_PAcB1,
        // otc_RoleAcPAcB1);
        ...
        // // String rel_P1_iri = prop_iri + "1";
        // //"http://crowd.fi.uncoma.edu.ar/IMPORT"
        // // + getAlphaNumericString(8) + "#P1";
        ...
        // // String rel_P2_iri = prop_iri + "2";
        // //"http://crowd.fi.uncoma.edu.ar/IMPORT"
        // // + getAlphaNumericString(8) + "#P2";
    ...
    public void type3ImportedAsKF(Metamodel kf, OWLClassExpression left, OWLClassExpression right) {
        ...
        if (NormalForm.isAtom(filler)) {
            ...
            // Dom \forall P B
            String fresh_left_iri = URI_FRESH + "/dom/forall#" + prop_frag + "_" + filler_frag;
            ObjectType ot_fresh_left = addObjectType(fresh_left_iri);
            ...
            // ¬A
            ObjectType ot_neg_left = addObjectType(URI_FRESH + "/negation#" + left_frag);
            ...
            kf.addEntity(ot_left);
            kf.addEntity(ot_neg_left);
            kf.addEntity(ot_fresh_left);
            kf.addEntity(ot_filler);
            kf.addEntity(ot_fresh_dom);
            kf.addEntity(ot_fresh_ran);

            // constraints for A and ¬A inheritance with Dom \forall P B
            ArrayList<ObjectType> cc_list = new ArrayList();
            ...
            Subsumption sub_left_fresh = addSubsumption(kf, ot_fresh_left, ot_left, cc, disj);
            cc_list.add(ot_left);
            disj_list.add(ot_left);

            Subsumption sub_neg_left_fresh = addSubsumption(kf, ot_fresh_left, ot_neg_left, cc, disj);
            cc_list.add(ot_neg_left);
            disj_list.add(ot_neg_left);
            ...
            // if relationship is null it means that their name already exists in the
            // metamodel, so it is not added
            if (r_P != null) {
            ...
            // P1 (\forall P B)
            String rel_P1_iri = URI_FRESH + "/forall#" + prop_frag + "_" + filler_frag;
            // IRIs for roles of P1
            String rel_fresh_P11_iri = URI_FRESH + "/forall#" + prop_frag + "-role-1" + "_" + filler_frag;
            String rel_fresh_P12_iri = URI_FRESH + "/forall#" + prop_frag + "-role-2" + "_" + filler_frag;
            ...
            // P2 ((A) \forall P B)
            String rel_P2_iri = URI_FRESH + "/forall#" + left_frag + "_" + prop_frag + "_" + filler_frag;
            // IRIs for roles of P2
            String rel_fresh_P21_iri = URI_FRESH + "/forall#" + left_frag + "_" + prop_frag + "-role-1" + "_"
                    + filler_frag;
            String rel_fresh_P22_iri = URI_FRESH + "/forall#" + left_frag + "_" + prop_frag + "-role-2" + "_"
                    + filler_frag;
            ...
            if (r_P2 != null) {
                ...
                r_P2 = kf.getRelationship(rel_P2_iri);
            }

            // P3 ((¬A) \forall P B)
            String rel_P3_iri = URI_FRESH + "/negation/forall#" + left_frag + "_" + prop_frag +
                    "_" + filler_frag;
            // IRIs for roles of P3
            String rel_fresh_P31_iri = URI_FRESH + "/negation/forall#" + left_frag + "_" +
                    prop_frag + "-role-1" + "_"
                    + filler_frag;
            String rel_fresh_P32_iri = URI_FRESH + "/negation/forall#" + left_frag + "_" +
                    prop_frag + "-role-2" + "_"
                    + filler_frag;

            // add cardinalities for P2
            ObjectTypeCardinality otc_role_P_31_DomRan = new ObjectTypeCardinality(getAlphaNumericString(8), "1", "*");
            ObjectTypeCardinality otc_role_P_32_DomRan = new ObjectTypeCardinality(getAlphaNumericString(8), "0", "*");

            kf.addConstraint(otc_role_P_31_DomRan);
            kf.addConstraint(otc_role_P_32_DomRan);

            ArrayList<Entity> P3L = new ArrayList();
            P3L.add(ot_neg_left);
            P3L.add(ot_filler);

            Relationship r_P3 = addRelationship(kf, rel_P3_iri, P3L);

            if (r_P3 != null) {
                // Add P2 roles and set mandatory
                Role role_P_31 = new Role(rel_fresh_P31_iri, ot_fresh_left, r_P3,
                        otc_role_P_31_DomRan);
                if (role_P_31.hasMandatoryConstraint()) {
                    kf.addConstraint(role_P_31.getMandatoryConstraint());
                }

                Role role_P_32 = new Role(rel_fresh_P32_iri, ot_filler, r_P3,
                        otc_role_P_32_DomRan);
                if (role_P_32.hasMandatoryConstraint()) {
                    kf.addConstraint(role_P_32.getMandatoryConstraint());
                }

                kf.addRole(role_P_31);
                kf.addRole(role_P_32);

                ArrayList<Role> Pres3 = new ArrayList();
                Pres3.add(role_P_31);
                Pres3.add(role_P_32);

                r_P3.setRoles(Pres3);
            } else {
                r_P3 = kf.getRelationship(rel_P3_iri);
            }

            // Object types Subsumption
            // Subsumption sub_P1P = new Subsumption(URI_IMPORT_CONCEPT +
            // getAlphaNumericString(8), r_P, r_P1);
            // Subsumption sub_P2P1 = new Subsumption(URI_IMPORT_CONCEPT +
            // getAlphaNumericString(8), r_P1, r_P2);
            // kf.addRelationship(sub_P1P);
            // kf.addRelationship(sub_P2P1);

            addSubsumption(kf, r_P, r_P1);
            addSubsumption(kf, r_P1, r_P2);
            addSubsumption(kf, r_P1, r_P3);
        }
    }
